	...
	<%}%>
           ...
           Statement st;
            try{
                ...
                ResultSet resultset = st.executeQuery("select * from menu");
                while(resultset.next()){ 
                    %>
                    <TR>
                    <form action="UpdateMenu" method="post">
                        <TD><input type="text" name="day" value=<%= resultset.getString("day") %> readonly></td>
                        <TD><input type="text" name="breakfast" value=<%= resultset.getString("breakfast") %> ></td>
                        <TD><input type="text" name="lunch" value=<%= resultset.getString("lunch") %> ></td>
                        <TD><input type="text" name="dinner" value=<%= resultset.getString("dinner") %> ></td>
