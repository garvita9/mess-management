<%-- 
    Document   : menu
    Created on : 28 JULY 2017, 10:53:30 AM
    Author     : GARVITA GARG
--%>
...
#primary_nav_wrap ul li:hover > ul
{
 ...
 #main
        ...
        <% 
            ...
            String sr="select * from foodmaster;";
            ResultSet resultset = 
...
<div style="background-color:#DEB887">
 ...
 <div>
  ...
  <input type="button" name="Back" value="Back" style="color:red; width: 125px;height: 50px; background-color: #DEB887" onclick="window.location.href='Bill.html' " >
