...
<li><a href="studentLogin.jsp">Faculty</a></li>
        ...
        <div style="background-color:#DEB887">
            <table align="center" style="width:1425px; height:570px;">
              <form action="StudentLogin" method="post" >  
                <div align="center"  class="login">
                <h3>Student/Faculty Login</h3>
                 ID: <input type="text" placeholder="Id" id="uid" name="id" style="width:270px"><br/><br/><br/> 
                <br/> Password: <input type="password" placeholder="Password" id="uroll" name="pwd" style="width:270px"><br/><br/>
                <br/><br/><a href="signup.jsp" >Sign Up?</a>
                 <%if(request.getAttribute("message")!=null)
{
	%>
	<h3 style="color:blue;"><%=request.getAttribute("message")%></h3>
	<%}%>
                 <br/><br/><input type="submit" value="Sign In"><br/><br/>
                </div>
            </form>    
            </table>
